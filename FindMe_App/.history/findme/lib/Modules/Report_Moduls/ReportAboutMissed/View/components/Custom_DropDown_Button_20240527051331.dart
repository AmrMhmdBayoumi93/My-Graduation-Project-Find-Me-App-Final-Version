...
class _Cusrom_Drop_Down_ButtonState extends State<Cusrom_Drop_Down_Button> {
  ...
  Widget build(BuildContext context) {
    ...
    final uniqueValues = widget.values.toSet().toList();
    
    // Ensure the initial value is in the list
    if (!uniqueValues.contains(_droppedValue)) {
      _droppedValue = null; // or set to a default value if applicable
    }
    ...
    return Container(
      ...
      child: Padding(
        ...
        child: DropdownButton<String?>(
          ...
          items: uniqueValues.map<DropdownMenuItem<String?>>((String? value) {
