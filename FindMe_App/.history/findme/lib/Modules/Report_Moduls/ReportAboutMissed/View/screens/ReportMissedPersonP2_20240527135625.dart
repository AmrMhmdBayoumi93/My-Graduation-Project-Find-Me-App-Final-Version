...
class _ReportMissedPersonP2State extends State<ReportMissedPersonP2> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('إبلاغ عن معثور عليه'),
      ),
      body: Padding(
        ...
        child: Column(
          children: <Widget>[
            ...
            SizedBox(height: 20),
            // Example of uploaded images (you can customize this part)
            Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
                CircleAvatar(
            ...
            DropdownButtonFormField<String>(
              ...
              items: <String>['محافظة 1', 'محافظة 2', 'محافظة 3'].map((String value) {
            ...
            DropdownButtonFormField<String>(
              ...
              items: <String>['منطقة 1', 'منطقة 2', 'منطقة 3'].map((String value) {
                return DropdownMenuItem<String>(
                  value: value,
                  child: Text(value),
                );
            ...
            ElevatedButton.icon(
              onPressed: () {},
              icon: Icon(Icons.map),
              label: Text('قم بتحديد الموقع على الخريطة'),
            ),
            Spacer(),
            ElevatedButton(
              onPressed: () {},
