...
import 'package:findme/Modules/Report_Moduls/ReportAboutMissed/view/components/Custom_Drop_Down_Button.dart';
...
class ReportMissedPersonP2 extends StatefulWidget {
  ...
  @override
  State<ReportMissedPersonP2> createState() => _ReportMissedPersonState();
}

class _ReportMissedPersonState extends State<ReportMissedPersonP2> {
  @override
  Widget build(BuildContext context) {
    ...
    // Ensure that the initial values are in the lists
    final provinces = Static_Data().provinces;
    final cairoNeighborhoods = Static_Data().cairoNeighborhoods;

    if (!provinces.contains(droppedValue)) {
      droppedValue = provinces.isNotEmpty ? provinces.first : null;
    }

    if (!cairoNeighborhoods.contains(droppedValue2)) {
      droppedValue2 = cairoNeighborhoods.isNotEmpty ? cairoNeighborhoods.first : null;
    }
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                ...
                Spacer(flex: 1),
                Apptext(
                  text: 'نأسف لمصابكم،ونعدكم ببذل قصاري ',
                  size: 17,
                ...
                Row(
                  ...
                  children: [
                    Cusrom_Drop_Down_Button(
                      initialValue: droppedValue,
                      values: provinces,
                      width: 150,
                    ),
                    const Spacer(flex: 1),
                    Cusrom_Drop_Down_Button(
                      initialValue: droppedValue2,
                      values: cairoNeighborhoods,
                      width: 150,
                    ),
                  ],
                ),
