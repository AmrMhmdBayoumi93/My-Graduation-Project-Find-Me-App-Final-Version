...
// Ensure these imports exist in your project or replace them with actual widgets
...
class SearchForFoundPerson extends StatelessWidget {
  const SearchForFoundPerson({super.key});

  @override
  Widget build(BuildContext context) {
    String dropedValue2 = 'رجل';
    String? droppedValue = 'القاهرة';
    String? droppedValue3 = 'حلوان'; // renamed droppedValue2 to droppedValue3 for uniqueness
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        Align(
                          alignment: Alignment.centerRight,
                          child: Cusrom_Drop_Down_Button(
                            droppedValue: droppedValue3,
...
// Mock Static_Data class for dropdown values, replace with actual data source
class Static_Data {
  List<String> cairoNeighborhoods = ['القاهرة', 'حلوان', 'حي 1', 'حي 2', 'حي 3'];
  List<String> provinces = ['القاهرة', 'محافظة 1', 'محافظة 2', 'محافظة 3'];
}
