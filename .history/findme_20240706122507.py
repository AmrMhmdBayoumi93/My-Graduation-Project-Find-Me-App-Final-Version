...
cred = credentials.Certificate(r'D:/IMPORTANT_CODES/Run-track-code/GRADUATION/findme_third_version/findme-938c1-firebase-adminsdk-z4fbr-bd6c91da14.json')
...
def upload_image():
    ...
    if file:
        ...
        if match_found:
            best_match_image = load_image_from_firebase(best_match_filename)
            best_match_image_base64 = encode_image_to_base64(best_match_image)
        else:
            best_match_image_base64 = None
