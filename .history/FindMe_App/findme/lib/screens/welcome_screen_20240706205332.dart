          ...
          child: Column(
            ...
            children: [
              ...
              const Padding(
                ...
                child: Center(
                  child: Text(
                    'هو تطبيق يساعد فى العثور على المفقودين عن طريق استخدام الذكاء الأصطناعى',
                ...
                onPressed: () {
                  Navigator.push(
                    ...
                    MaterialPageRoute(builder: (context) {
                      return  LoginScreen(name:'test for name',phone: 'test for ph',);
                    }),
                  );
                },
                child: const Text(
