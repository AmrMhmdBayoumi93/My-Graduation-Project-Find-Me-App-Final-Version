...
class MissedCubit extends Cubit<MissedStates> {
  ...
  Future<void> uploadImage(File imageFile, var context) async {
        ...
        if (response.data['match_found'] == true) {
          ...
          Navigator.of(context).push(MaterialPageRoute(
            builder: (context) => BlocProvider(
              create: (context) => Regis(),
              child: PersonLostResultFound(imageData:base64Decode( response.data['best_match']['image']) ),
            ),
          ));
        }
      } else {
