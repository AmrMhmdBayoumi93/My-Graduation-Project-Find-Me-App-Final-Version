...
class ReportMissedPersonP1 extends StatefulWidget {
   ...
   ReportMissedPersonP1({super.key, required this.name, required this.phone});
...
class _ReportMissedPersonP1State extends State<ReportMissedPersonP1> {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: BlocBuilder<MissedCubit, MissedStates>(
        ...
        const SizedBox(height: 80.0),
          ...
          state is MissedLoadingState ? Center(child: const CircularProgressIndicator()) :
                      ElevatedButton(
                        style: ButtonStyle(
                          backgroundColor:
                        ...
                        onPressed: () async {
                                ...
                                await context.read<MissedCubit>().uploadImage(imageFile!,context,widget.name,widget.age,widget.gender,widget.date,widget.place,widget.description,widget.phone);
